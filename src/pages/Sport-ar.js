...
class SportAr extends Component {
    state={
        data:[]
    }
    componentDidMount() {

        axios.get("https://newsapi.org/v2/top-headlines?category=sports&language=ar&apiKey=033f8eb6abbb4481a8d57b7c2c6c1ee0")
            .then(res=>{
